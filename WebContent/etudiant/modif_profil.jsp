							...
							<div class="box-body">
								<div class="register-box-body">
									...
									<form action="etudiant" method="post">
										<input type="hidden" name="actionPost" value="modifProfil" />
										<div class="form-group has-feedback">
											<input type="text" class="form-control" name="nom"
												value="${etudiant.nom}" placeholder="nom" required> <span
												class="glyphicon glyphicon-user form-control-feedback"></span>
										</div>
										<div class="form-group has-feedback">
											<input type="text" class="form-control" name="prenom"
												value="${etudiant.prenom}" placeholder="prenom" required>
											<span class="glyphicon glyphicon-user form-control-feedback"></span>
										</div>
										
										<div class="form-group has-feedback">
											<input type="email" class="form-control" name="email"
												value="${etudiant.email}" type="email" placeholder="Email"
												required> <span
										...
										<div class="form-group has-feedback">
											<input type="tel" class="form-control" name="numTel"
												value="${etudiant.numTel}" type="tel" pattern="^(?:(?:\+|00)33|0)\s*[1-9](?:[\s.-]*\d{2}){4}$"
