						...
						<div class="box">
							<div class="box-body">
								<div class="register-box-body">
									...
									<form action="etudiant/annonce?actionPost=addOffreArticle" method="post"  enctype="multipart/form-data"  >
										...
										<div class="form-group has-feedback">
											...
											<input name="prixFixe" value="prixFixe" type="checkbox">
										</div>
	...
	<script >
	  ...
	  uploadField.onchange = function() {
	      if(this.files[0].size > 2000000){
	    	  document.getElementById("demo").innerHTML = "<div class=\"callout callout-danger\"><p>la taille d'image ne doit pas depassé 2 mega ?</p></div>";
	         this.value = "";
	      }else{
